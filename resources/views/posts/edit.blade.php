        ...
        <div class="col-8 offset-2">
            ...
            <form action="{{ route('post.update') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="post_title" class="form-control" value="{{ old('post_title') ?? $post->post_title }}">
                    <span class="text-danger">@error('post_title') {{ $message }} @enderror</span>
                </div>
                <div class="form-group">
                    <label for="post_content">Content</label>
                    <textarea name="post_content" rows="10" class="form-control">{{ old('post_content') ?? $post->post_content }}</textarea>
                </div>
